...
class ToolBar(QtWidgets.QWidget):
    ...
    PLAYTIME_COMMANDS = [
        c.ToolCommand.reset,
        c.ToolCommand.border,
        c.ToolCommand.pause,
        c.ToolCommand.play,
        c.ToolCommand.save,
        c.ToolCommand.threat,
        c.ToolCommand.zen,
        c.ToolCommand.flip,
    ]

    NON_PLAYTIME_COMMANDS = [
        c.ToolCommand.load,
        c.ToolCommand.option,
        c.ToolCommand.movie,
    ]
    ...
    def __init__(self, parent=None):
        super().__init__(parent=parent)
        self._setup_ui()
        self.set_playtime_btn_visibility(False)
    ...
    def set_playtime_btn_visibility(self, visibility):
        for cmd, btn in self._buttons.items():
            if cmd in self.PLAYTIME_COMMANDS:
                btn.setVisible(visibility)

            if cmd in self.NON_PLAYTIME_COMMANDS:
                btn.setVisible(not(visibility))
...
class BoardWidget(QtWidgets.QDialog):
    ...
    def __init__(self, board, parent=None):
        ...
        self._pychess_pixmap = QtGui.QPixmap(c.IMAGE.CHESSLY_IMAGE_FILE_PATH)
